            ...
            <div className="relative z-10 mx-auto max-w-7xl px-8 lg:px-16 w-full">
              <div className="max-w-xl">
                ...
                <h1 className="font-serif font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight">
                  Two Guides<br />
                  One <span className="italic text-sunset-orange">Passion</span>
                </h1>
                <p className="font-sans text-base text-white/70 max-w-md leading-relaxed">
                  Guiding you through Asia with experience, care and passion
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-14 md:py-24 bg-navy">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-loose">
                    Ready to Travel{" "}
                    <span className="italic text-sunset-orange">With Us</span>
